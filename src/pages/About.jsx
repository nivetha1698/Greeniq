  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 text-center relative overflow-hidden px-4">
        <h1 data-aos="fade-down" data-aos-duration="1000" className="text-3xl md:text-4xl lg:text-5xl font-serif text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-800 mb-6">
          Who We Are?
        </h1>
      ...
      <section className="max-w-6xl mx-auto py-16 px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
       ...
       <div className="flex justify-center md:justify-end">
        <img data-aos="fade-left" data-aos-duration="1200"
          src="/images/nursery1.jpg" alt="Our nursery" className="rounded-xl shadow-lg w-72 md:w-96 object-cover"/>
       </div>
      </section>
      ...
      <section className="py-16 px-4">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div data-aos="zoom-in" data-aos-duration="800" className="p-6 bg-gray-50 rounded-xl shadow hover:shadow-lg transition">
